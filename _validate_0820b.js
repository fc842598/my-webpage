...
const slugs = [
  'ziwei-kanpan-buneng-zhikan-minggong','ziwei-shenggong-zhengque-yongfa','ziwei-duigong-jiexing-jiexian',
  'ziwei-hualu-bu-yiding-haoshi','ziwei-huaquan-bu-yiding-zhangquan','ziwei-huake-bu-yiding-youming',
  'ziwei-huaji-bu-yiding-huaishi','ziwei-miaowang-luoxian-shizhan','ziwei-shaxing-bu-kenpa',
  'ziwei-kongjie-bu-shi-meiyou','ziwei-daxian-jiaotuo-qi','ziwei-xiaoxian-shizhan-yongfa',
  'ziwei-geju-bu-neng-taoshuyin','ziwei-kanpan-xiankan-dafangxiang','ziwei-tongyi-pan-butong-jiedu',
  'ziwei-kanpan-bie-wen-weishenme','ziwei-xingxing-zhijian-huixiangying','ziwei-wuxing-jusheng-buneng-yingtao',
  'ziwei-kanpan-yaokan-shunxu-bushi-zhongdian','ziwei-ganzhi-yongchu-buzhi-shi-fuhao',
  'ziwei-kanpan-xiankan-shengnian-sihua','ziwei-minggong-wu-zhuxing-zenmakan','ziwei-sanfang-sizheng-shizhan',
  'ziwei-liunian-shizhan-jiedu','ziwei-kanpan-yao-kanren-bukanpan','ziwei-tonggong-butong-daxian',
  'ziwei-feixing-sihua-zenmeyong','ziwei-kanpan-xiankan-youmeiyou-jie','ziwei-kanpan-buzhi-kan-jixiong',
  'ziwei-mingpan-shi-dongtai','ziwei-kanpan-yao-kan-nianling','ziwei-zihua-shi-shenme',
  'ziwei-kanpan-yao-jiehe-shiji','ziwei-shiergong-bushi-guli','ziwei-kanpan-yongshen',
  'ziwei-daxian-minggong-yu-benming','ziwei-kanpan-bu-zhuiqiu-wanmei','ziwei-panduan-yi-jian-shi-nengfou-cheng',
  'ziwei-liuyue-liuri-yongfa','ziwei-kanpan-xian-ding-ti-yong'
];
let errors = 0;
...
if (errors === 0) console.log('\nALL CHECKS PASSED (' + slugs.length + ' articles, ' + (slugs.length*2) + ' HTML files)');
