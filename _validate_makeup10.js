...
const slugs = [
  'ziwei-geju-zifu-tonggong', 'ziwei-geju-fuxiang-chaoyuan', 'ziwei-geju-jiyue-tongliang',
  'ziwei-geju-shapol', 'ziwei-geju-riyue-bingming', 'ziwei-geju-juri-tonggong',
  'ziwei-geju-wutan', 'ziwei-geju-lianqi-qisha', 'ziwei-geju-tanlang-huaji',
  'ziwei-geju-ziwei-pojun'
];
...
if (errors.length === 0) {
  console.log('VALIDATION PASSED. All 10 makeup articles, indexes, topic, feeds, sitemaps OK.');
