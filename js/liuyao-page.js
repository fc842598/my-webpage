(function () {
  ...
  const LIUYAO_COIN_FRONT_SRC = '../images/liuyao-coins/qianlong-coin-front.webp';
  const LIUYAO_COIN_BACK_SRC = '../images/liuyao-coins/qianlong-coin-back.webp';
  ...
  function reviewQuestionLocally(question) {
    ...
    const hasOutcome = /(能不能|能否|是否|可否|会不会|要不要|该不该|适不适合|可以吗|成不成|有没有|何时|多久|结果|赚钱|盈利|回本|成交|签约|通过|合格|及格|过线|过关|考过|考上|拿证|拿到证|拿到|录取|复合|结婚|分手|离职|跳槽|搬家|买|卖|租|开店|上线|发布|推进|合作|投资|到账|怀孕|好转)/i.test(normalizedQuestion);
