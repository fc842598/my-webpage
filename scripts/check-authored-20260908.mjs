...
const articles = (await import('../docs/article-drafts/humanizer-20260908.mjs')).default.slice();
articles[2] = (await import('../docs/article-drafts/humanizer-20260908-replacement.mjs')).default;
const errors = [];
