export const articles = [
  {
    ...
    demandEvidence: {
      sourceType: "editorial-gap",
      reference: "常见现实决策：想离职但分不清该换岗位、公司还是城市",
      query: "紫微斗数换工作先看官禄宫还是迁移宫",
      audience: "正在考虑转岗、跳槽或跨城发展，又分不清问题来自岗位还是平台的用户",
      decisionTrigger: "用户已经准备投简历或提出离职，需要在行动前判断真正要改变的是职责、公司还是城市",
      whySeparate: "该问题比较的是岗位与平台两条不同决策线，有独立的宫位顺序和现实动作，不能并入宽泛的事业运文章",
    },
    supportPlan: [
      "命宫要与财帛、官禄、迁移一起看",
      "官禄宫说明岗位、制度和责任出口",
