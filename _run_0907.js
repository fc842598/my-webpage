...
const groups=[
 require('./_t07_fuzhu.js'),
 require('./_t07_geju.js'),
 require('./_t07_kanpan.js'),
 require('./_t07_sihua.js'),
 require('./_t07_ganqing.js'),
 require('./_t07_yingyong.js'),
 require('./_t07_liunian_faq.js')
];
