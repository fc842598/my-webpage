"""
补齐 female / lower-six / ordinary / hai-hour 口袋剩余卦型

范围：
- 只补 1930 年内、当前 lower-trigram 147 特例会命中的剩余 unique upper/lower 组合
"""
import ctypes
...
OUT_JSON = Path(__file__).parent / "tianji-female-hai-ordinary-pocket-2.json"
...
SAMPLES = [
    {
        "id": "1930-01-09-2100-f",
        "birth": (1930, 1, 9, 21, 0),
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-4", "upper-7"],
        "notes": "候选：山雷颐",
    },
    {
        "id": "1930-02-16-2100-f",
        "birth": (1930, 2, 16, 21, 0),
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-1", "upper-5"],
        "notes": "候选：风天小畜",
    },
    {
        ...
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-7", "upper-5"],
        "notes": "候选：风山渐",
    },
    {
        "id": "1930-02-25-2100-f",
        "birth": (1930, 2, 25, 21, 0),
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-1", "upper-1"],
        "notes": "候选：乾为天",
    },
    {
        ...
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-7", "upper-8"],
        "notes": "候选：地山谦",
    },
    {
        "id": "1930-03-17-2100-f",
        "birth": (1930, 3, 17, 21, 0),
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-4", "upper-8"],
        "notes": "候选：地雷复",
    },
    {
        "id": "1930-03-27-2100-f",
        "birth": (1930, 3, 27, 21, 0),
        "gender": "female",
        "coverageTags": ["female", "lower-six", "ordinary", "hai-hour", "pocket-2", "lower-7", "upper-4"],
        "notes": "候选：雷山小过",
    },
]
