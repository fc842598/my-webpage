"""
补抓 female / lower-six / ordinary follow-up 样本

目的：
- 继续区分女命下六时 ordinary 是否按卦型分流
- 本轮只抓 4 条：震为雷 / 雷天大壮 / 艮为山 / 山地剥
"""
import ctypes
...
OUT_JSON = Path(__file__).parent / "tianji-lower-six-followup.json"
...
SAMPLES = [
    {
        "id": "1930-01-14-1700-f",
        "birth": (1930, 1, 14, 17, 0),
        "notes": "震为雷 candidate",
    },
    {
        "id": "1930-01-03-2100-f",
        "birth": (1930, 1, 3, 21, 0),
        "notes": "雷天大壮 candidate",
    },
    {
        "id": "1930-02-15-2100-f",
        "birth": (1930, 2, 15, 21, 0),
        "notes": "艮为山 candidate",
    },
    {
        "id": "1930-01-20-1900-f",
        "birth": (1930, 1, 20, 19, 0),
        "notes": "山地剥 candidate",
    },
]
