"""
采集 female / lower-six / ordinary / hai-hour / lower=8 口袋

目标：
- 验证 风地观@亥 与 雷地豫@亥 在天纪软件中的后天卦是否稳定
"""
import ctypes
...
OUT_JSON = Path(__file__).parent / "tianji-lower8-hai-pocket.json"
...
SAMPLES = [
    {
        "id": "1930-02-23-2100-f",
        "birth": (1930, 2, 23, 21, 0),
        "gender": "female",
        "notes": "风地观@亥 对照1",
    },
    {
        "id": "1930-04-20-2100-f",
        "birth": (1930, 4, 20, 21, 0),
        "gender": "female",
        "notes": "风地观@亥 对照2",
    },
    {
        "id": "1930-02-26-2100-f",
        "birth": (1930, 2, 26, 21, 0),
        "gender": "female",
        "notes": "雷地豫@亥 对照1",
    },
    {
        "id": "1930-04-16-2100-f",
        "birth": (1930, 4, 16, 21, 0),
        "gender": "female",
        "notes": "雷地豫@亥 对照2",
    },
]
