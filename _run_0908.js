...
const groups=[
 require('./_t08_geju.js'),
 require('./_t08_fuzhu.js'),
 require('./_t08_kanpan.js'),
 require('./_t08_sihua.js'),
 require('./_t08_ganqing.js'),
 require('./_t08_yingyong.js'),
 require('./_t08_liunian_faq.js')
];
