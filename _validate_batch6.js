...
const slugs = [
  'ziwei-ziwei-zuoming',
  'ziwei-taiyang-zuoming',
  'ziwei-wuqu-zuoming',
  'ziwei-tiantong-zuoming',
  'ziwei-lianzhen-zuoming',
  'ziwei-tianfu-zuoming',
  'ziwei-taiyin-zuoming',
  'ziwei-tanlang-zuoming',
  'ziwei-jumen-zuoming',
  'ziwei-tianxiang-zuoming'
];
...
for (const slug of slugs) {
  ...
  check(cn.includes('ziwei-main-stars.html'), slug + ' CN main-stars breadcrumb');
...
const topic = fs.readFileSync(path.join(__dirname, 'articles', 'ziwei-main-stars.html'), 'utf8');
